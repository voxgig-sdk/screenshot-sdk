...
class ScreenshotTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ScreenshotTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ScreenshotTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ScreenshotTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
