...
class ScreenshotTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ScreenshotTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ScreenshotTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ScreenshotTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
