...
class ScreenshotCacheFeature extends ScreenshotBaseFeature
{
    ...
    private function _through(ScreenshotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
