...
class ScreenshotNetsimFeature extends ScreenshotBaseFeature
{
    ...
    private function _simulate(ScreenshotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ScreenshotContext $ctx, array $applied): void
    {
        $client = $this->client;
