...
// Screenshot SDK idempotency feature
...
class ScreenshotIdempotencyFeature extends ScreenshotBaseFeature
{
    ...
    private function _mutating(ScreenshotContext $ctx): bool
    {
