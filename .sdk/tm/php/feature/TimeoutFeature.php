...
// Screenshot SDK timeout feature
...
class ScreenshotTimeoutFeature extends ScreenshotBaseFeature
{
    ...
    private function _with_timeout(ScreenshotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ScreenshotContext $_ctx, float $ms): void
    {
        $client = $this->client;
