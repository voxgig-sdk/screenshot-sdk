...
class ScreenshotProxyFeature extends ScreenshotBaseFeature
{
    ...
    public function init(ScreenshotContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ScreenshotContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
