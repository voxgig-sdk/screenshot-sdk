...
// Screenshot SDK ratelimit feature
...
class ScreenshotRatelimitFeature extends ScreenshotBaseFeature
{
    ...
    private function _acquire(ScreenshotContext $ctx): void
    {
    ...
    private function _track(ScreenshotContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
