...
// Screenshot SDK utility: fetcher
...
class ScreenshotFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ScreenshotSDK/1.0)';
    ...
    public static function call(ScreenshotContext $ctx, string $fullurl, array $fetchdef): array
    {
