...
// Screenshot SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ScreenshotMakeRequest
{
    public static function call(ScreenshotContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ScreenshotResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ScreenshotResponse($fetched);
        } else {
