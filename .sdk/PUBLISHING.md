...
|---|---|---|
| `ts/` | @voxgig-sdk/screenshot-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/screenshot-sdk \
      --repository voxgig-sdk/screenshot-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/screenshot-sdk` shows it, and
`npm trust revoke @voxgig-sdk/screenshot-sdk --id=<id>` removes it.
