...
func registerTools(server *mcp.Server, client *sdk.ScreenshotSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "screenshot_list",
		Description: "List records from Screenshot. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Load a single record from Screenshot. " +
...
func runOp(client *sdk.ScreenshotSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ScreenshotSDK, name string) (sdk.ScreenshotEntity, error) {
