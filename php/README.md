...
The PHP SDK for the Screenshot API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'screenshot_sdk.php';

$client = new ScreenshotSDK([
    "apikey" => getenv("SCREENSHOT_APIKEY"),
]);
```
...
```php
require_once 'screenshot_sdk.php';
$client = new ScreenshotSDK($options);
```
...
```
php/
├── screenshot_sdk.php          -- Main SDK class
...
The main class (`screenshot_sdk.php`) exports the SDK class
