...
// Screenshot SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ScreenshotTransformResponse
{
    public static function call(ScreenshotContext $ctx): mixed
    {
        ...
        $transform = ScreenshotHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
