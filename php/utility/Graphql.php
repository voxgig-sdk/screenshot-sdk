...
// Screenshot SDK utility: graphql
//
...
class ScreenshotGraphql
{
    ...
    // equivalent.
    public static function body(ScreenshotContext $ctx): mixed
    {
    ...
    public static function errors(ScreenshotContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
