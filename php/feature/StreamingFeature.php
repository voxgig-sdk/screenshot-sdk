...
// Screenshot SDK streaming feature
...
class ScreenshotStreamingFeature extends ScreenshotBaseFeature
{
    ...
    private function _iterate(ScreenshotResult $result): \Generator
    {
    ...
    private function _streamable(ScreenshotContext $ctx): bool
    {
