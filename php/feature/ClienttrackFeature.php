...
// Screenshot SDK clienttrack feature
...
class ScreenshotClienttrackFeature extends ScreenshotBaseFeature
{
    ...
    public function PostConstruct(ScreenshotContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Screenshot-SDK';
