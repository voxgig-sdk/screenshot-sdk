...
// Screenshot SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ScreenshotTestFeature extends ScreenshotBaseFeature
{
    ...
    public function init(ScreenshotContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ScreenshotContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ScreenshotParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ScreenshotContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ScreenshotContext $ctx, $op, $args): array
    {
