...
class ScreenshotRbacFeature extends ScreenshotBaseFeature
{
    ...
    private function _required(ScreenshotContext $ctx): ?string
    {
    ...
    private function _reject(ScreenshotContext $ctx, string $required): void
    {
    ...
    private function _track(ScreenshotContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
