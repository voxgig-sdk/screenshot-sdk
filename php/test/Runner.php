...
class ScreenshotTestRunner
{
    ...
    {
        $live = self::getenv('SCREENSHOT_TEST_LIVE');
        $override = self::getenv('SCREENSHOT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SCREENSHOT_TEST_EXPLAIN');
...
class_alias('ScreenshotTestRunner', 'Runner');
class_alias('ScreenshotHelpers', 'Helpers');
