...
require_once __DIR__ . '/../screenshot_sdk.php';
...
{
    private static function utility(): ScreenshotUtility
    {
        return new ScreenshotUtility();
    }
    ...
    private static function ctx(array $over = []): ScreenshotContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ScreenshotContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ScreenshotOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ScreenshotError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ScreenshotOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ScreenshotMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ScreenshotOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ScreenshotMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ScreenshotOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ScreenshotMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ScreenshotSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ScreenshotMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = ScreenshotMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ScreenshotSpec([]),
            'response' => null,
            'result' => new ScreenshotResult([]),
        ]);
        [, $err] = ScreenshotMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ScreenshotSpec(['step' => 's']),
            'response' => new ScreenshotResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ScreenshotResult([]),
        ]);
        [, $err] = ScreenshotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ScreenshotSpec(['step' => 's']),
            'response' => new ScreenshotResponse(self::resp(200, ['v' => 1])),
            'result' => new ScreenshotResult([]),
        ]);
        [, $err] = ScreenshotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ScreenshotSpec(['step' => 's']),
            'response' => new ScreenshotResponse(self::resp(200, ['v' => 2])),
            'result' => new ScreenshotResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ScreenshotMakeResponse::call($ctx);
    ...
    {
        $preset = new ScreenshotResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ScreenshotSpec([]),
            'response' => new ScreenshotResponse([]),
            'result' => new ScreenshotResult([]),
        ...
        [$got, $err] = ScreenshotMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ScreenshotResult([])]);
        [, $err] = ScreenshotMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ScreenshotSpec([]), 'result' => null]);
        [, $err] = ScreenshotMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ScreenshotSpec(['step' => 's']),
            'result' => new ScreenshotResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ScreenshotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ScreenshotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ScreenshotSpec(['step' => 's']),
            'result' => new ScreenshotResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ScreenshotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ScreenshotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ScreenshotResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ScreenshotSpec([]),
            'result' => new ScreenshotResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ScreenshotMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ScreenshotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ScreenshotError('boom', 'boom');
        $utility->fetcher = function (ScreenshotContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ScreenshotSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ScreenshotMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ScreenshotContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ScreenshotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ScreenshotContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ScreenshotSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ScreenshotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ScreenshotResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ScreenshotSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ScreenshotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ScreenshotMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ScreenshotMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ScreenshotResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ScreenshotDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ScreenshotResult(['ok' => false])]);
        $this->expectException(ScreenshotError::class);
        ScreenshotDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ScreenshotResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ScreenshotMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ScreenshotMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ScreenshotBaseFeature();
        $b = new ScreenshotBaseFeature();
        ScreenshotFeatureAdd::call($ctx, $a);
        ScreenshotFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ScreenshotBaseFeature
    {
        $f = new ScreenshotBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ScreenshotFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ScreenshotContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ScreenshotSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ScreenshotPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ScreenshotPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ScreenshotResponse(['headers' => null]),
            'result' => new ScreenshotResult([]),
        ]);
        ScreenshotResultHeaders::call($ctx);
