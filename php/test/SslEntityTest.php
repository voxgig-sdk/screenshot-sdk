...
class SslEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SCREENSHOT_TEST_SSL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ssl_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SCREENSHOT_TEST_SSL_ENTID");
