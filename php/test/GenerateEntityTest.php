...
class GenerateEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SCREENSHOT_TEST_GENERATE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function generate_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SCREENSHOT_TEST_GENERATE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["SCREENSHOT_TEST_GENERATE_ENTID"]);
