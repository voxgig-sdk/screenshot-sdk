...
// Screenshot SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ScreenshotOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ScreenshotOmni::structfix($now, Struct::undef()))
                        !== json_encode(ScreenshotOmni::structfix($val, Struct::undef()))) {
