...
// Screenshot SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ScreenshotSDK::test)
...
{
    private const SDK_CLASS = 'ScreenshotSDK';
    ...
    private const SDK_BASE = 'screenshot_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../screenshot_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
