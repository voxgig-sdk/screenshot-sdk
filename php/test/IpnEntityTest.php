...
class IpnEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SCREENSHOT_TEST_IPN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ipn_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SCREENSHOT_TEST_IPN_ENTID");
