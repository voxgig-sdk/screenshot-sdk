# Screenshot Golang SDK Reference

Complete API reference for the Screenshot Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ScreenshotSDK`
