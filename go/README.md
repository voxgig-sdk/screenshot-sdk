# Screenshot Golang SDK



The Golang SDK for the Screenshot API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/screenshot-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/screenshot-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/screenshot-sdk/go=../screenshot-sdk/go
```
...
import (
    "fmt"
    "os"
    sdk "github.com/voxgig-sdk/screenshot-sdk/go"
)

func main() {
    client := sdk.NewScreenshotSDK(map[string]any{
        "apikey": os.Getenv("SCREENSHOT_APIKEY"),
    })
...
```
SCREENSHOT_TEST_LIVE=TRUE
SCREENSHOT_APIKEY=<your-key>
```
...
| `DnsResult` | `(data map[string]any) ScreenshotEntity` | Create a DnsResult entity instance. |
| `Domain` | `(data map[string]any) ScreenshotEntity` | Create a Domain entity instance. |
| `EmailValidate` | `(data map[string]any) ScreenshotEntity` | Create an EmailValidate entity instance. |
| `Generate` | `(data map[string]any) ScreenshotEntity` | Create a Generate entity instance. |
| `Grammar` | `(data map[string]any) ScreenshotEntity` | Create a Grammar entity instance. |
| `Ipn` | `(data map[string]any) ScreenshotEntity` | Create an Ipn entity instance. |
| `Redact` | `(data map[string]any) ScreenshotEntity` | Create a Redact entity instance. |
| `Ssl` | `(data map[string]any) ScreenshotEntity` | Create a Ssl entity instance. |
| `Utility` | `(data map[string]any) ScreenshotEntity` | Create an Utility entity instance. |
| `Whoi` | `(data map[string]any) ScreenshotEntity` | Create a Whoi entity instance. |

### Entity interface (ScreenshotEntity)

All entities implement the `ScreenshotEntity` interface.
...
```
github.com/voxgig-sdk/screenshot-sdk/go/
├── screenshot.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/screenshot-sdk/go`) re-exports everything needed
