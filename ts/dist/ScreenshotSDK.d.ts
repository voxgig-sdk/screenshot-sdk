...
declare class ScreenshotSDK {
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): ScreenshotSDK;
    tester(testopts?: any, sdkopts?: any): ScreenshotSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof ScreenshotSDK;
export { stdutil, config, BaseFeature, ScreenshotEntityBase, ScreenshotSDK, SDK, };
