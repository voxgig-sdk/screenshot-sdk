...
function envOverride(m) {
    if ('TRUE' === process.env.SCREENSHOT_TEST_LIVE ||
        'TRUE' === process.env.SCREENSHOT_TEST_OVERRIDE) {
    ...
    m.SCREENSHOT_TEST_EXPLAIN = process.env.SCREENSHOT_TEST_EXPLAIN || m.SCREENSHOT_TEST_EXPLAIN;
    return m;
}
