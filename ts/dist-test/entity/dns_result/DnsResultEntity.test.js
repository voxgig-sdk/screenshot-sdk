...
(0, node_test_1.describe)('DnsResultEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set SCREENSHOT_TEST_DNS_RESULT_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['SCREENSHOT_TEST_DNS_RESULT_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'SCREENSHOT_TEST_DNS_RESULT_ENTID': idmap,
        'SCREENSHOT_TEST_LIVE': 'FALSE',
        'SCREENSHOT_TEST_EXPLAIN': 'FALSE',
        'SCREENSHOT_APIKEY': '',
    });
    idmap = env['SCREENSHOT_TEST_DNS_RESULT_ENTID'];
