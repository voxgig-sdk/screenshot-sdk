...
(0, node_test_1.describe)('DnsResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ScreenshotSDK({
...
function liveScenariosActive() { return false && process.env.SCREENSHOT_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'SCREENSHOT_TEST_DNS_RESULT_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.ScreenshotSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.SCREENSHOT_APIKEY,
        }));
        let idmap = env['SCREENSHOT_TEST_DNS_RESULT_ENTID'];
    ...
    const client = new __1.ScreenshotSDK({
        base: 'http://localhost:8080',
