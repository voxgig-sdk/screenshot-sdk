# Screenshot TypeScript SDK



The TypeScript SDK for the Screenshot API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/screenshot-sdk/releases](https://github.com/voxgig-sdk/screenshot-sdk/releases)
...
```ts
const client = ScreenshotSDK.test()
...
```ts
const client = new ScreenshotSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `ScreenshotSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ScreenshotSDK.test(testopts?, sdkopts?)` | `ScreenshotSDK` | Create a test-mode client. |
...
| `client` | `client(): ScreenshotSDK` | Return the parent SDK client. |
...
screenshot/
├── src/
│   ├── ScreenshotSDK.ts        # Main SDK class
