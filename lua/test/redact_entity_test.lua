...
describe("RedactEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SCREENSHOT_TEST_REDACT_ENTID JSON to run live")
      return
    end
...
function redact_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SCREENSHOT_TEST_REDACT_ENTID")
