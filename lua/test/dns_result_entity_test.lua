...
describe("DnsResultEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SCREENSHOT_TEST_DNS_RESULT_ENTID JSON to run live")
      return
    end
...
function dns_result_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SCREENSHOT_TEST_DNS_RESULT_ENTID")
