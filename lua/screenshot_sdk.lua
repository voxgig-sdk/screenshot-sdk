...
local ScreenshotSDK = {}
ScreenshotSDK.__index = ScreenshotSDK
...
ScreenshotSDK._make_feature = _make_feature


function ScreenshotSDK.new(options)
  local self = setmetatable({}, ScreenshotSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ScreenshotSDK:options_map()
...
function ScreenshotSDK:get_utility()
  return Utility.copy(self._utility)
end


function ScreenshotSDK:get_root_ctx()
  return self._rootctx
end


function ScreenshotSDK:prepare(fetchargs)
...
function ScreenshotSDK:direct(fetchargs)
...
-- by passing it.
function ScreenshotSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ScreenshotSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ScreenshotSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function ScreenshotSDK:DnsResult(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Domain(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:EmailValidate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Generate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Grammar(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Ipn(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Redact(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Ssl(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Utility(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function ScreenshotSDK:Whoi(data)
...
function ScreenshotSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ScreenshotSDK.new(sdkopts)
  sdk.mode = "test"
