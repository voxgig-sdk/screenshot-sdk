...
The Lua SDK for the Screenshot API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/screenshot-sdk/releases)),
...
```
lua/
├── screenshot_sdk.lua    -- Main SDK module
...
The main module (`screenshot_sdk`) exports the SDK constructor
