# Screenshot SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ScreenshotSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ScreenshotSDK(...) and ScreenshotSDK.test(...) become
#      ScreenshotSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "screenshot_sdk"
_SDK_CLASS = "ScreenshotSDK"
