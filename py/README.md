...
The Python SDK for the Screenshot API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/screenshot-sdk/releases)) or
...
client = ScreenshotSDK({
    "apikey": os.environ.get("SCREENSHOT_APIKEY"),
})
```
...
```
py/
├── screenshot_sdk.py         -- Main SDK module
