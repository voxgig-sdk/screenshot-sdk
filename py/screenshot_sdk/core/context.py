...
from screenshot_sdk.core.helpers import get_ctx_prop, to_map
...
class ScreenshotContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ScreenshotSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(rp, ScreenshotResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ScreenshotError(code, msg, self)
