...
module ScreenshotTestRunner
  ...
  def self.env_override(m)
    live = getenv("SCREENSHOT_TEST_LIVE")
    override = getenv("SCREENSHOT_TEST_OVERRIDE")
    ...
    explain = getenv("SCREENSHOT_TEST_EXPLAIN")
    m["SCREENSHOT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
