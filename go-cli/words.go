...
func registerSDKWords(r *eng.Registry, client *sdk.ScreenshotSDK) {
...
func runOp(client *sdk.ScreenshotSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
