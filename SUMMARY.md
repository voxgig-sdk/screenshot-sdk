...
- `screenshot_list`: List records for an entity. Supported entities: `domain`, `ssl`, `whoi`.
- `screenshot_load`: Load one record for an entity. Supported entities: `dns_result`, `email_validate`, `generate`, `ipn`, `utility`.
